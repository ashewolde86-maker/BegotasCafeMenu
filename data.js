...
const defaultMenuData = {
    specials: [
        {
            id: 1,
            name: 'Mojito with strawberry',
            name_am: 'ሞጂቶ ከስትራቤሪ',
            price: 170,
            description: 'Refreshing strawberry mojito',
            description_am: 'ሚማቃዊ ስትራቤሪ ሞጂቶ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/da231783-c684-4a58-8057-49175efa958a.jpg',
            category: 'Special',
            mainCategory: 'Drink',
        },
        {
            id: 2,
            name: 'Special caramel',
            name_am: 'ልዩ ካራሜል',
            price: 150,
            description: 'Special caramel drink',
            description_am: 'ልዩ ካራሜል መጠጥ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/6aa81e10-2260-47eb-b291-7dac077658b9.jpg',
            category: 'Special',
            mainCategory: 'Drink',
        },
        {
            id: 3,
            name: 'Special cheesebsa',
            name_am: 'ልዩ ቺዝባ',
            price: 280,
            description: 'Special cheese bread',
            description_am: 'ልዩ ቺዝ ዳቦ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/b74a6d47-2aec-4a65-b9d5-be6539c4a379.jpg',
            category: 'Special',
            mainCategory: 'Food',
        },
        {
            ...
            name_am: 'ልዩ ፒዛዝ',
            price: 480,
            description: 'Special house pizza',
            description_am: 'ልዩ የቤቱ ፒዛዝ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/4173933f-dbf0-4066-9bbe-e3bea07325c2.jpg',
            category: 'Special',
            mainCategory: 'Food',
        },
        {
            id: 5,
            name: 'Special shewarma',
            name_am: 'ልዩ ሸዋርማ',
            price: 500,
            description: 'Special shewarma platter',
            description_am: 'ልዩ ሸዋርማ ፕላተር',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/1a9d35ca-3ab7-42e5-8a32-0182c2e60528.jpg',
            category: 'Special',
            mainCategory: 'Food',
        },
        {
            ...
            name_am: 'ቤጎታስ ልዩ ፒዛዝ',
            price: 500,
            description: 'Begotas signature pizza',
            description_am: 'ቤጎታስ ፊርማዊ ፒዛዝ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/085de016-6caa-4299-9e61-537eddccc561.jpg',
            category: 'Special',
            mainCategory: 'Food',
        },
    ],
    products: [
        {
            ...
            description_am: 'አቮካዶ ጡስ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/ad5f8397-c41a-4183-9706-fbc43400d698.jpg',
            category: 'Normal Juice',
            category_am: 'የተራገበ ጡስ',
            mainCategory: 'Drink',
            subCategory: 'Juice',
        },
        {
            ...
            description_am: 'ከወቭት ጋር አቮካዶ ሼይክ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/dbe29068-bf2b-48b3-8485-439fa0c3d130.jpg',
        ...
        {
            id: 103,
            name: 'Avocado with egg',
            name_am: 'አቮካዶ ከእምብጣን',
            price: 250,
            description: 'Avocado served with scrambled egg',
            description_am: 'ከብራን እጃት ጋር አቮካዶ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/b851349c-7657-4b7d-aeb9-90af36229d57.jpg',
            category: 'Pasta & Rice',
            category_am: 'ፓስታ እና ሩዝ',
            mainCategory: 'Food',
        ...
        },
        {
            ...
            description_am: 'ከትኩሳዎች ጋር ጣፋጭ የቤፍ ፓቲ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/9a455e6f-0775-4d2b-b3ad-dd12604e6d25.jpg',
            category: 'Burger',
            category_am: 'በርገር',
            mainCategory: 'Food',
            subCategory: 'Burger',
        },
        {
            ...
            name_am: 'ቤፍ ሸዋርማ',
            price: 450,
            description: 'Tender beef shewarma with sauce',
            description_am: 'ከሳስ ጋር ጣፋጭ የቤፍ ሸዋርማ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/cc01a5c9-0080-4773-be82-bb1e01bb245e.jpg',
            category: 'Shawarma & Wrap',
            category_am: 'ሻዋርማ እና ራፕ',
            mainCategory: 'Food',
            subCategory: 'Shawarma & Wrap',
        },
        {
            id: 106,
            name: 'Bread 1/2',
            name_am: 'እኩል ዳቦ',
            price: 20,
            description: 'Half portion of bread',
            description_am: 'ግማሽ ዳቦ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/46743a9e-b273-43b0-b856-6e2e16e13ca8.jpg',
            category: 'Extra',
            category_am: 'ተጨማሪ',
            mainCategory: 'Extra',
            subCategory: 'Extra',
        },
        {
            ...
            description_am: 'ከፎም ጋር ሞቃት ካፑቺኖ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/fa927cef-63e8-4ca7-bdf3-1f86f5f20432.jpg',
            category: 'Hot Drinks',
            category_am: 'ትኩስ መጠጦች',
            mainCategory: 'Drink',
        ...
        },
        {
            ...
            description_am: 'ጣፋጭ ካራሜል ማቺያቶ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/cbb1962a-50c9-4a30-baf8-905a27eb65d5.jpg',
            category: 'Hot Drinks',
            category_am: 'ትኩስ መጠጦች',
            mainCategory: 'Drink',
            subCategory: 'Hot Drinks',
        },
        {
            ...
            name_am: 'ክላብ ሳንድዊች',
            price: 400,
            description: 'Triple-decker sandwich with fillings',
            description_am: 'በሶስት ንቃት ሳንድዊች',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/8f0bc995-0876-46f9-9da6-fc6a0a51045c.jpg',
            category: 'Sandwich',
            category_am: 'ሳንድዊች',
            mainCategory: 'Food',
        ...
        },
        {
            ...
            name_am: 'ኩባ',
            price: 30,
            description: 'Small cup for takeout',
            description_am: 'ለ� carryን ኩባ',
            image: 'https://digitalmenu.ctechcloud.net/images/Products/37d79c0b-f1ae-4174-8f22-9486219a4aa1.jpg',
            category: 'Extra',
            category_am: 'ተጨማሪ',
            mainCategory: 'Extra',
            subCategory: 'Extra',
